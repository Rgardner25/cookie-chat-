...
module.exports = class Base
  ...
  renderDocFile: (segments, fileInfo, missingDoc, callback) ->
    ...
    fsTools.mkdir path.dirname(docPath), '0755', (error) =>
      ...
      footer = '<a href="https://github.com/druide/citare-scriptum" target="_blank">Generated by Citare scriptum</a>'
      if @project.options.footer
        footer = @project.options.footer + '  |  ' + footer
